...
create table appointment(appointId INT AUTO_INCREMENT PRIMARY KEY,appointDate DATE,location varchar(10),patientId int,FOREIGN KEY(patientId) REFERENCES patient(patientId));
